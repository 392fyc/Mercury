...
description: >-
  Root-cause-first debugging workflow. Use when encountering any bug, test failure,
...
<!-- Cherry-picked from obra/superpowers (MIT, Copyright 2025 Jesse Vincent)
     Source: https://github.com/obra/superpowers/blob/917e5f5/skills/systematic-debugging/SKILL.md
...
1. **Create Failing Test Case**
   ...
   - Follow TDD methodology: write a failing test first, then implement the fix.
