...
| `04-research/` | 专项研究报告（prompt 架构、框架分析等） | Research agent / Main |
...
项目内部文档统一存放于 `.mercury/docs/`:

| 路径 | 内容 |
|------|------|
| `.mercury/docs/architecture.md` | 项目架构 |
| `.mercury/docs/git-flow.md` | Git 分支规范 |
| `.mercury/docs/kb-structure.md` | 本文件 |
| `.mercury/docs/sot-workflow.md` | SoT 任务流程 |
